...
export const TERMS_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    items: [
      'All electric bikes, parts, and accessories are subject to availability at the selected branch or warehouse.',
      'Prices are listed in Pakistani Rupees (PKR) and may change without prior notice. The price confirmed at checkout is the price you pay.',
      'Product images and specifications are for reference. Minor variations in color or finish may occur between batches.',
      'Promotional offers, discounts, and sale prices apply only during the stated promotion period and cannot be combined unless explicitly stated.',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      'We collect and process personal data necessary to fulfill orders, bookings, and customer support as described in our Privacy Policy.',
      'Order history, payment records, and service logs may be retained for accounting, warranty, and legal compliance purposes.',
      'We do not sell your personal information to third parties. Data may be shared with payment processors and delivery partners as needed.',
    ],
  },
  {
