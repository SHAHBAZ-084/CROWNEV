                    ...
                    return (
                      <li key={key} className="flex items-start justify-between gap-3 px-4 py-3">
                        <div className="min-w-0 flex-1">
                          <p className="font-medium text-sm leading-snug text-ink">{row.name}</p>
                          {formatProductMetaLine(row) && (
                            <p className="mt-0.5 text-xs leading-snug text-text-muted">{formatProductMetaLine(row)}</p>
                          )}
                          <p className="mt-0.5 text-xs text-text-muted font-mono truncate">{row.code}</p>
                        </div>
