      ...
      >
        <span
          className={`mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full transition-colors ${
            isOpen ? 'bg-accent text-white' : 'bg-slate-100 text-brand-light'
          }`}
        >
  ...
  return (
    <div className="min-h-[60vh] bg-slate-100">
      ...
      <section className="mx-auto max-w-3xl px-4 pb-16 lg:px-8">
        {filtered.length === 0 ? (
          <p className="rounded-2xl border border-dashed border-border bg-white px-6 py-10 text-center text-sm text-text-muted">
